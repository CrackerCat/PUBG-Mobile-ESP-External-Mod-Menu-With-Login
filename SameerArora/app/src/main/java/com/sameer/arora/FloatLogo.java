...
public class FloatLogo extends Service implements View.OnClickListener {
    ...
    public String memory = MainActivity.Path;
    public String bypass = MainActivity.Paths;
    ...
    void createOver(){
        ...
        final LinearLayout extra =mFloatingView.findViewById(R.id.extra);
        ...
        final TextView extraBtn=mFloatingView.findViewById(R.id.extraBtn);

        final Switch isBypass = mFloatingView.findViewById(R.id.isBypass);
        final CheckBox isAim = mFloatingView.findViewById(R.id.isAim);
        final CheckBox isLock = mFloatingView.findViewById(R.id.isLock);
        final CheckBox isLess = mFloatingView.findViewById(R.id.isLess);
        final CheckBox isMagic = mFloatingView.findViewById(R.id.isMagic);
        final CheckBox isBlack = mFloatingView.findViewById(R.id.isblack);
        final CheckBox isBody = mFloatingView.findViewById(R.id.isbody);
        final CheckBox isCross = mFloatingView.findViewById(R.id.isCross);
        final CheckBox isView = mFloatingView.findViewById(R.id.isView);

        playerBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                itemBtn.setBackgroundColor(Color.parseColor("#546f7a"));
                playerBtn.setBackgroundColor(Color.parseColor("#ff9f00"));
                vehicleBtn.setBackgroundColor(Color.parseColor("#546f7a"));
                extraBtn.setBackgroundColor(Color.parseColor("#546f7a"));
        ...
        itemBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                itemBtn.setBackgroundColor(Color.parseColor("#ff9f00"));
                playerBtn.setBackgroundColor(Color.parseColor("#546f7a"));
                vehicleBtn.setBackgroundColor(Color.parseColor("#546f7a"));
                extraBtn.setBackgroundColor(Color.parseColor("#546f7a"));
        ...
        vehicleBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                itemBtn.setBackgroundColor(Color.parseColor("#546f7a"));
                playerBtn.setBackgroundColor(Color.parseColor("#546f7a"));
                vehicleBtn.setBackgroundColor(Color.parseColor("#ff9f00"));
                extraBtn.setBackgroundColor(Color.parseColor("#546f7a"));
                items.setVisibility(View.GONE);
                player.setVisibility(View.GONE);
        ...
        extraBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                playerBtn.setBackgroundColor(Color.parseColor("#546f7a"));
                vehicleBtn.setBackgroundColor(Color.parseColor("#546f7a"));
                extraBtn.setBackgroundColor(Color.parseColor("#ff9f00"));
                items.setVisibility(View.GONE);
                player.setVisibility(View.GONE);
                vehicle.setVisibility(View.GONE);
        ...
        isBypass.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (isChecked) {
                    execute_any_shell("touch /storage/emulated/0/.sameer/bypass");
                    execute_any_shell(bypass);
                    Toast.makeText(getApplicationContext(), "Activated ✔", Toast.LENGTH_LONG).show();
                } else {
                    Toast.makeText(getApplicationContext(), "Antiban cant turn off", Toast.LENGTH_LONG).show();
                }
            }
        });

        isAim.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (isChecked) {
                    execute_any_shell("touch /storage/emulated/0/.sameer/aim");
                    execute_any_shell(memory);
                    Toast.makeText(getApplicationContext(), "Activated ✔", Toast.LENGTH_LONG).show();
                } else {
                    execute_any_shell("touch /storage/emulated/0/.sameer/aim_on");
                    execute_any_shell(memory);
                    Toast.makeText(getApplicationContext(), "De-Activated ❌", Toast.LENGTH_LONG).show();
                }
            }
        });
        ...
        isLock.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (isChecked) {
                    execute_any_shell("touch /storage/emulated/0/.sameer/lock");
                    execute_any_shell(memory);
                    Toast.makeText(getApplicationContext(), "Activated ✔", Toast.LENGTH_LONG).show();
                } else {
                    execute_any_shell("touch /storage/emulated/0/.sameer/lock_on");
                    execute_any_shell(memory);
                    Toast.makeText(getApplicationContext(), "De-Activated ❌", Toast.LENGTH_LONG).show();
                }
            }
        ...
        isLess.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (isChecked) {
                    execute_any_shell("touch /storage/emulated/0/.sameer/less");
                    execute_any_shell(memory);
                    Toast.makeText(getApplicationContext(), "Activated ✔", Toast.LENGTH_LONG).show();
                } else {
                    execute_any_shell("touch /storage/emulated/0/.sameer/less_on");
                    execute_any_shell(memory);
                    Toast.makeText(getApplicationContext(), "De-Activated ❌", Toast.LENGTH_LONG).show();
                }
            }
        ...
        isMagic.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (isChecked) {
                    execute_any_shell("touch /storage/emulated/0/.sameer/magic");
                    execute_any_shell(memory);
                    Toast.makeText(getApplicationContext(), "Activated ✔", Toast.LENGTH_LONG).show();
                } else {
                    execute_any_shell("touch /storage/emulated/0/.sameer/magic_on");
                    execute_any_shell(memory);
                    Toast.makeText(getApplicationContext(), "De-Activated ❌", Toast.LENGTH_LONG).show();
                }
            }
        ...
        isBlack.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (isChecked) {
                    execute_any_shell("touch /storage/emulated/0/.sameer/black");
                    execute_any_shell(memory);
                    Toast.makeText(getApplicationContext(), "Activated ✔", Toast.LENGTH_LONG).show();
                } else {
                    execute_any_shell("touch /storage/emulated/0/.sameer/black_on");
                    execute_any_shell(memory);
                    Toast.makeText(getApplicationContext(), "De-Activated ❌", Toast.LENGTH_LONG).show();
                }
            }
        ...
        isBody.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (isChecked) {
                    execute_any_shell("touch /storage/emulated/0/.sameer/body");
                    execute_any_shell(memory);
                    Toast.makeText(getApplicationContext(), "Activated ✔", Toast.LENGTH_LONG).show();
                } else {
                    execute_any_shell("touch /storage/emulated/0/.sameer/body_on");
                    execute_any_shell(memory);
                    Toast.makeText(getApplicationContext(), "De-Activated ❌", Toast.LENGTH_LONG).show();
                }
            }
        ...
        isCross.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (isChecked) {
                    execute_any_shell("touch /storage/emulated/0/.sameer/cross");
                    execute_any_shell(memory);
                    Toast.makeText(getApplicationContext(), "Activated ✔", Toast.LENGTH_LONG).show();
                } else {
                    execute_any_shell("touch /storage/emulated/0/.sameer/cross_on");
                    execute_any_shell(memory);
                    Toast.makeText(getApplicationContext(), "De-Activated ❌", Toast.LENGTH_LONG).show();
                }
            }
        ...
        isView.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (isChecked) {
                    execute_any_shell("touch /storage/emulated/0/.sameer/view");
                    execute_any_shell(memory);
                    Toast.makeText(getApplicationContext(), "Activated ✔", Toast.LENGTH_LONG).show();
                } else {
                    execute_any_shell("touch /storage/emulated/0/.sameer/view_on");
                    execute_any_shell(memory);
                    Toast.makeText(getApplicationContext(), "De-Activated ❌", Toast.LENGTH_LONG).show();
                }
            }
    ...
    private void execute_any_shell (final String _cmd) {
    ...
    void Init(){
        ...
        final RadioButton fps5 = mFloatingView.findViewById(R.id.fps45);
